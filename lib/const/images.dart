...
class ImagePath {
  ...
  static const String DEV = "$imageDir/shohel.jpg";
  static const String CV = "$imageDir/Resume-Shohel-Rana.pdf";

  static const String VYBZ = "$imageDir/vybz.jpg";
  static const String DAVID = "$imageDir/shohel.jpg";
  ...
  static const String DEV_SHISHIR = "$imageDir/shohel.jpg";
  ...
  // Duronto
  static const String FLUTTER_DURONTO_COVER =
      "$projectsDir/duronto/duronto.png";

  // vDOC
  static const String vDOC_COVER =
      "$projectsDir/vdoc/vdoc.png";

  // BMART
  static const String BMART_COVER =
      "$projectsDir/bmart/bmart.png";

  // MYSPORTS
  static const String MYSPORTS_COVER =
      "$projectsDir/mySports/mysports.png";

  // MYSPORTS
  static const String SURVEY_COVER =
      "$projectsDir/survey/survey.png";
}
