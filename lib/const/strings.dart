part of values;
  ...
  // Contact Page
  const String GET_IN_TOUCH = "Get in touch.";
  const String CONTACT_MSG =
  ...
  const String EMAIL_ERROR_MSG = "* Please enter a valid email";
  const String SUBJECT = "Subject";
  const String SUBJECT_ERROR_MSG =
  ...
  const String TECHNOLOGY_USED = "Technology Used";
  const String LAUNCH_APP = "Launch App";
  const String SOURCE_CODE = "Source Code";
  const String NEXT_PROJECT = "Next Project";
  ...
  const String EXPERIENCE_2 = "EXPERIENCE";
  const String EDUCATION = "EDUCATION";

  const String SEND_ME_A_MESSAGE = "Send me a message";
  const String VIEW_PORTFOLIO = "View Portfolio";
  ...
  //Form Hint Texts
  const String NAME_HINT_TEXT = "Name";
  const String PHONE_HINT_TEXT = "Phone (Optional)";
  const String EMAIL_HINT_TEXT = "Email";
  const String MESSAGE_HINT_TEXT = "Message";
  ...
  const String LARAVEL = "Laravel";
  const String SQL = "SQL";
  const String WORDPRESS = "Wordpress";
  const String BOOTSTRAP = "Bootstrap";
  const String HTML_CSS = "HTML/CSS";

  //routes
  const String LOADING_PAGE = "/";
  const String HOME_SCREEN = "/home";
  const String ABOUT_PAGE = "/about";
  const String WORKS_PAGE = "/works";
  const String CONTACT_PAGE = "/contact";
  const String PROJECT_PAGE = "/project";
  const String PROJECT_DETAIL_PAGE = "/project-detail";
  const String SERVICES_PAGE = "/services";
  const String MESSAGE_PAGE = "/message-me";
  const String EXPERIENCE_PAGE = "/experience";
  const String RESUME_PAGE = "/resume";
  const String CERTIFICATION_PAGE = "/certifications";
  ...
  //Certificate Urls
  const String ASSOCIATE_ANDROID_DEV_URL =
      "https://www.credential.net/b296da88-d6be-4bb5-9756-b13efea3a421";
  const String DATA_SCIENCE_CERT_URL =
      "https://graduation.udacity.com/confirm/7CGEJAFR";
  const String ANDROID_BASICS_CERT_URL =
      "https://graduation.udacity.com/confirm/9VTDRN5K";

  //AwardedBy
  const String GOOGLE = "Google";
  const String UDACITY = "Udacity";

  //CertificationType
  const String ASSOCIATE_ANDROID_DEV = "Associate Android Developer";
  const String DATA_SCIENCE = "Data Science";
  const String ANDROID_BASICS = "Android Basics";
...
const String DURATION_2 = "MAY 2021 - SEP 2021";
  ...
  const String NIMBUS_CATEGORY = "Portfolio / CV.";
  const String NIMBUS_DESIGNER = "Web Genius Labs.";
  const String NIMBUS_SUBTITLE =
      "Nimbus (Portfolio & CV), a beautifully designed portfolio website.";
  const String NIMBUS_DETAIL =
      "Nimbus is a beautifully designed Portfolio & CV website built with flutter";
  const String NIMBUS_GITHUB_URL =
...
const String SURVEY_PLAYSTORE_URL =
  ...
  const String PROGRAMMING_FOR_DATA_SCIENCE_PLATFORM = "Python.";
  const String PROGRAMMING_FOR_DATA_SCIENCE_SUBTITLE =
      "Udacity Programming For Data Science Course";
  const String PROGRAMMING_FOR_DATA_SCIENCE_DETAIL =
      "Udacity Programming For Data Science Course.";
  const String PROGRAMMING_FOR_DATA_SCIENCE_GITHUB_URL =
  ...
  const String PYTHON_ALGORITHMS_SUBTITLE =
      "Data structures and interview questions implemented in JavaScript with explanations and links to further readings.";
  const String PYTHON_ALGORITHMS_DETAIL =
      "Data structures and interview questions implemented in JavaScript with explanations and links to further readings.";
  const String PYTHON_ALGORITHMS_GITHUB_URL =
  ...
  //API
  const String BASE_URL = "https://portfolio-api-chi.vercel.app/api";
  const String GET_IN_TOUCH_POINT = "/getintouch";
